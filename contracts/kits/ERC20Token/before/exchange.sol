...
contract UniswapLiteBase {
    ...
    function _tokenToEth(
        ...
        ERC20(tokenAddress).approve(exchange, tokenAmount);
        ...
        returns (uint256 tokensBought)
    {
      ...
      function addLiquidity(uint256 min_liquidity, uint256 max_tokens, uint256 deadline) external payable returns (uint256 amount){
